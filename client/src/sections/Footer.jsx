  ...
  return (
    <footer className="bg-[#001E36] pl-24 grid grid-cols-1 overflow-hidden justify-center items-center w-full mt-[2%] pt-1 p-[5%] sm:grid sm:grid-cols-3">
      ...
      <ul className="ml-10 ">
        ...
        <li className="text-[#04F9ED] font-medium text-lg ">
          <a href="/">Home</a>
        </li>
        <li className="text-[#04F9ED] font-medium text-lg ">
        ...
        <div className="flex my-4">
          <a href="https://www.facebook.com/profile.php?id=100071094020686&mibextid=ZbWKwL">
            <img
              ...
              alt=""
            />
            <h2 className="text-xl text-white inline font-semibold">
              Facebook
            </h2>
          </a>
        </div>
        ...
        <div className="flex my-4">
          <a href="https://t.me/+bSkp7e1AL305Njdk">
            <img
              ...
              alt=""
            />
            <h2 className="text-xl inline text-white font-semibold">
              Telegram
            </h2>
          </a>
        </div>
        ...
        <div className="flex my-4">
          <a href="grooming1st@gmail.com">
            <img
              ...
              alt=""
            />
            <h2 className="text-xl inline text-white font-semibold">Email</h2>
          </a>
        </div>
      </div>
      ...
      <span className="text-sm text-gray-500 font-semibold sm:text-center dark:text-gray-400">
        © 2023{" "}
