...
function Staff() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if(!row){
        const response = await axios.post('https://groom-health-care.onrender.com/staff/create-staff', formDataToSend, {
          headers:{
        ...
        const response = await axios.post(`https://groom-health-care.onrender.com/staff/edit-staff/${row[index].id}`, formDataToSend, {
          headers:{
            'Content-Type': 'multipart/form-data',
          }
